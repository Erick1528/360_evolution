<div class=" h-[640px]
 sm:max-h-[907px] sm:h-full
xl:h-[700px] w-full relative">

    <img src="{{ asset('build/assets/banner.webp') }}" alt=""
        class=" h-full
        sm:max-h-[907px] sm:h-[907px]
    ...
    xl:px-[124px] xl:pt-[80px] xl:pb-[30px] h-full absolute top-0 left-0 flex xl:flex-row items-center justify-center w-full">
        ...
        <div
         ...
         text-white flex flex-col items-center justify-center text-center  h-full max-w-[594px] w-full">
            ...
            max-w-[594px] text-[80px] w-full text-center font-bold italic leading-[98px]">
                EVOLUCIÓN 360°</h1>
