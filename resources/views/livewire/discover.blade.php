...
px-[20px] py-[40px] flex flex-col gap-y-[40px] font-[playfair]">
        ...
        <div class="  p-8 text-center flex flex-col gap-y-[36px] bg-[#F8F8F8] rounded-r-[10px] w-full">
            ...
            text-[14px] leading-[17px] font-[montserrat]">
                ...
                comienzo de una nueva historia. Ese libro no se vende; se regala con sentido. <span
                    class=" font-semibold">Ese instante puede llevar
                    tu nombre</span></p>
    ...
    <livewire:impact-card />

    <livewire:donation-options-card />

    <livewire:impact-guarantee-card />
    ...
    <div class="shadow-[2px_2px_4px_rgba(0,0,0,0.1)] rounded-[10px] flex">
        ...
        <div class="  p-8 text-center flex flex-col gap-y-[36px] bg-[#F8F8F8] rounded-r-[10px] w-full">
            ...
            <div class=" flex flex-col gap-y-[16px]">
                <p class=" text-base leading-[19px] text-[#0F355E] font-extrabold">Global Editorial EA</p>

                <p class=" italic text-[12px] leading-[14px] text-[rgba(0,0,0,0.60)]">Semillas de conocimiento, cosechas
                    de esperanza.</p>
            </div>
